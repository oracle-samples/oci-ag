...
class TestStreamTransformer(unittest.TestCase):
    ...
    def test_access_bundle_changed(self):
        ...
        self.assertEqual(self.transformer._prepared_events[0]['data'][0]['event_timestamp'], '18-Aug-25 06:15:19.032641 PM')
    ...
    def test_approval_workflow_changed(self):
        ...
        self.assertEqual(self.transformer._prepared_events[0]['operation_type'], 'UPDATE')
        self.assertEqual(self.transformer._prepared_events[0]['data'][0]['summary'], '{[beneficiary-manager]}{[beneficiary][owner]}{[manager-chain]}{[group,f64ba5a1-cab3-4dd0-b354-f37dde47a7cd,Test IC Managed (New)]}{[custom-user,globalId.ICF.f0f364e5-2804-4790-ab72-7a5caf405059.0d80c7ccdea4d336bd329ce8dc9ccd3b,Zulma Milner]}')    
        self.assertEqual(self.transformer._prepared_events[0]['data'][0]['event_timestamp'], '25-Aug-25 08:47:33.535442 PM')
        self.assertEqual(self.transformer._prepared_events[0]['data'][0]['tenancy_id'], 'ocid.tenancy.oc1..tenant_test_1_p2')
        self.assertEqual(self.transformer._prepared_events[0]['data'][0]['service_instance_id'], 'ocid1.instance.oc1..cc73a..instance_test_1_p2')
