...
def bootstrap_base_environment_variables(cfg):
    try:
        ...
        os.environ["DFA_ADW_WALLET_SAVE_ABSOLUTE_PATH"] = cfg["DFA_ADW_WALLET_SAVE_ABSOLUTE_PATH"]
        os.environ["DFA_ADW_EWALLET_PEM_SECRET_NAME"] = cfg["DFA_ADW_EWALLET_PEM_SECRET_NAME"]
        os.environ["DFA_ADW_EWALLET_PEM_SAVE_ABSOLUTE_PATH"] = cfg[
...
def bootstrap_local_machine_environment_variables(
    ini_file_location: str = None, section: str = None
):
    ...
    for key in custom_configs:
        ...
        os.environ[env_var_name] = custom_configs[env_var_name]
        logger.info(
