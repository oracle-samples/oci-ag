...
class ResourceTimeSeriesTable(BaseTable):
    _table_name = "resource_ts"
    _schema = None
...
class ResourceStateTable(BaseStateTable, ResourceTimeSeriesTable):
    _table_name = "resource_state"

    def get_unique_contraint_definition_details(self):
        return {
            "name": "DFA_UNQ_RES_ST_CONST",
